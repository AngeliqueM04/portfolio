...
export const site = {
  ...
  focus: "MS Finance Candidate, Johns Hopkins Carey Business School",
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    scopeNote:
      "This case study presents the modeling and fairness work in full. Details beyond the model itself are withheld, as the underlying product remains in active, independent development.",
    phases: [
      {
        id: "phase-1",
        ...
        problem:
          "Small independent mortgage brokers process applications manually, with no affordable path to the ML-driven risk tools large lenders use. Building a defensible model for this space takes more than accuracy. It requires explainability that holds up under ECOA and fair-lending scrutiny.",
        approach:
          "Decision Tree, Random Forest, and XGBoost classifiers were trained and compared on 933,769 cleaned HMDA Loan/Application Register records (2018 to 2024), using an 80/20 stratified split and class-weight balancing to address a 79/21 class imbalance. Random Forest was selected for its combination of predictive performance, zero overfit gap, and SHAP-based per-applicant explainability. A three-part fairness evaluation, demographic parity, disparate impact, and equalized odds, was run and validated with 1,000-iteration bootstrap resampling.",
        result:
        ...
        stats: [
          {
            ...
            value: "0.83",
            note: "The genuine predictive number. Phase 1's 0.996 traced back to the interest-rate leak",
            emphasis: "lead",
          },
          {
            label: "Gender gap (matched)",
            value: "+0.6 pp",
            note: "Resolved; the hypothesis confirmed. DTI and LTV explain the gap Agent 1 flagged",
            emphasis: "secondary",
          },
          {
